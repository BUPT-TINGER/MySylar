...
public:
    ...
    void schedule(FiberOrCb fc, int thread = -1) {
        ...
        {
            MutexType::Lock lock(m_mutex); //这里锁是自己封装的，大括号那自动加锁解锁，RAII原则，那为什么不用自带的比如lock_guard？
            //可能因为加锁解锁过程中要做的其他额外操作挺多的，就得自己封装一下，那感觉可以尝试hook一下？不过完全模拟hook麻烦事挺多的，所以就可能这样简化一下也方便
